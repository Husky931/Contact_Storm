        ...
        <section className="bg-[var(--background)] py-16">
            <div className="mx-auto max-w-6xl px-6">
                <div className="text-center">
                    ...
                    <h2 className="font-heading mt-4 text-3xl text-slate-900">Studio Services</h2>
                </div>
                <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {services.map((service) => (
                        <div key={service.title} className="overflow-hidden rounded bg-white shadow">
                            <Image
                                src={service.image}
                                alt={service.title}
                                width={640}
                ...
                <div className="mt-10 flex justify-center">
                    <a
                        href="#"
                        className="rounded bg-[var(--brand-red)] px-8 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-white"
                    >
                        View All Services
                    </a>
                </div>
