                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            ...
                            <WeChatQRPopup
                                ...
                                trigger={
                                    <a
                                        href="#contact"
                                        className="inline-flex items-center gap-2 rounded border border-white/60 px-6 py-3 text-sm font-semibold tracking-[0.2em] text-white uppercase transition-colors hover:bg-white/10"
                                    >
                                        <svg
                                            viewBox="0 0 24 24"
